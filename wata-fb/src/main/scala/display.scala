...
object Font:
  ...
  /** the charge-anomaly mark's power plug (plan 0073): prongs, body, cable —
   *  drawn beside an `X` on the red field in `WataLogic.chargeAlertView`.
   *  Hand-drawn like 0x8C-0x90 and likewise NOT in the generator's output. */
  val ICON_PLUG: scala.Int = 0x91
  ...
  val glyphs: IArray[Int] = IArray(
    ...
    0x50, 0x50, 0xf8, 0xf8, 0x70, 0x20, 0x20, 0x00, // 0x91  power plug (prongs/body/cable)
