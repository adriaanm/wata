...
object Font:
   ...
   *  the result in. 0x8C (the cellular mast) and 0x8D (the favorite star) were
   *  drawn by hand in the same 5x8 style and are NOT in the generator's
   *  output. A constant `Array`
