...
/**
 * @deprecated Use encodeAudioCode instead
 */
...
/**
 * @deprecated Use decodeAudioCode instead
 */
export function decodeMfsk(
  samples: Float32Array,
  config: AudioCodeConfig = DEFAULT_CONFIG,
): Promise<unknown> {
  return decodeAudioCode(samples, config);
}
...
// Re-export types for compatibility (AudioCodeConfig already exported above)

/**
 * @deprecated Use DEFAULT_CONFIG instead
 */
export const DEFAULT_MFSK_CONFIG = DEFAULT_CONFIG;
