/** The glyph mapping: VGlyph codes into text UIKit can draw — wata-mac's
 *  glyphs.scala with UILabel under it (honest duplication per plan 0044;
 *  fold only when both Apple clients are green and the seams show).
 *
